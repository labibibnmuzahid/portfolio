...
const C = {
    ...
    D = ({
        ...
        var t;
        const [e, i] = m(), n = (t = g.getConfig()) == null ? void 0 : t.langDefinitions;
        f(() => {
            const o = d.on("locale", l => {
                l !== e && i(l)
            }, {
                eager: !0
            });
